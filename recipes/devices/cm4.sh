...
device_image_tweaks() {
	...
	cat <<-EOF >"${ROOTFSMNT}/etc/apt/sources.list.d/raspi.list"
		...
		deb http://archive.raspbian.org/raspbian bullseye main firmware non-free rpi
                #deb-src http://archive.raspbian.org/raspbian bullseye main firmware non-free rpi
	EOF
