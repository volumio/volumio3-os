...
declare -A CUSTOM_PKGS=(
  ...
  [mpd]="https://github.com/volumio/volumio3-os-static-assets/raw/master/custom-packages/mpd/mpd_0.23.5-1"
...
VOL_BE_REPO="https://github.com/foonerd/volumio3-backend.git"
VOL_BE_REPO_BRANCH="pi-installer"
